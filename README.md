...
Bước 2: Cài đặt Script điều hướng (DUPC)Mặc dù script cài đặt đã hỗ trợ, bạn hãy đảm bảo công cụ dupc đã sẵn sàng để có thể gọi từ bất cứ đâu trong hệ thống. Kiểm tra bằng lệnh:Bashdupc help
